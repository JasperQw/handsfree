  ...
  return (
    <Background>
      <View className="flex-1 items-center">
        <Text className="mt-32 text-3xl font-semibold text-center">Mom</Text>

        <Avatar.Image
          source={require("../../assets/images/profile_pic_default.jpg")}
          size={120}
          className="mt-5 w-32 h-32 rounded-full"
        />
        <Text className="mt-10 text-xl">00 : 05</Text>
